...
const About = () => {
    return (
        <section id="about" className="scroll-mt-14 bg-base-100" aria-labelledby="about-heading">
            {/* Bio */}
                ...
                <div className="grid gap-12 lg:grid-cols-[auto_1fr] lg:items-start">
                    ...
                    <div className="space-y-5 animate-fade-in-up animation-delay-100">
                        <div>
                            ...
                            <h2 id="about-heading" className="text-4xl sm:text-5xl font-bold tracking-tight">
                                Frank R. Mendez
                            </h2>
                        </div>
                        <p className="text-base-content/70 text-base leading-relaxed max-w-2xl">
                            Senior Software Engineer with 10+ years specializing in frontend architecture, design
                            systems, and full-stack TypeScript applications.
                        </p>
                        <p className="text-base-content/70 text-base leading-relaxed max-w-2xl">
                            I architect scalable UIs with React and TypeScript — from component libraries to production
                            apps used by thousands — and build backend APIs that power them.
                        </p>
                        <p className="text-base-content/70 text-base leading-relaxed max-w-2xl">
                            Currently at Virtido AG, building enterprise SaaS tools with React, Node.js, and AWS.
                            Exploring AI-assisted developer tooling and LLM integrations.
                        </p>
            ...
            <section className="bg-base-200" aria-labelledby="experience-heading">
                <div className="container mx-auto px-4 sm:px-6 py-14">
                    <div className="mb-8 animate-fade-in-up">
                        ...
                        <h3 id="experience-heading" className="text-3xl sm:text-4xl font-bold tracking-tight">
                            Experience
                        </h3>
                    </div>
                    <WorkExperience />
